...
public class BlinkSignature implements Cloneable {
  ...
  public JsonObject toJson() {
    ...
    object.add("n", new JsonPrimitive(Block.REGISTRY.getNameForObject(north).toString()));
    object.add("e", new JsonPrimitive(Block.REGISTRY.getNameForObject(east).toString()));
    object.add("s", new JsonPrimitive(Block.REGISTRY.getNameForObject(south).toString()));
    object.add("w", new JsonPrimitive(Block.REGISTRY.getNameForObject(west).toString()));
