...
public class BlinkSignature implements Cloneable {
  ...
  public JsonObjectBuilder toJsonBuilder() {
    return Json.createObjectBuilder()
        .add("n", Block.blockRegistry.getNameForObject(north).toString())
        .add("e", Block.blockRegistry.getNameForObject(east).toString())
        .add("s", Block.blockRegistry.getNameForObject(south).toString())
        .add("w", Block.blockRegistry.getNameForObject(west).toString());
  }
}
