    ...
    try {
      ...
      for (JsonElement groupVal : element.getAsJsonArray()) {
        ...
        BlinkSignature sig = new BlinkSignature(
            Block.blockRegistry.getObject(new ResourceLocation(jsonSig.getAsJsonPrimitive("n").getAsString())),
            Block.blockRegistry.getObject(new ResourceLocation(jsonSig.getAsJsonPrimitive("e").getAsString())),
            Block.blockRegistry.getObject(new ResourceLocation(jsonSig.getAsJsonPrimitive("s").getAsString())),
            Block.blockRegistry.getObject(new ResourceLocation(jsonSig.getAsJsonPrimitive("w").getAsString()))
        );
