...
public class Location {
  ...
  public JsonObject toJson() {
    ...
    object.add("d", new JsonPrimitive(world.provider.getDimensionId()));
    object.add("x", new JsonPrimitive(this.pos.getX()));
    object.add("y", new JsonPrimitive(this.pos.getY()));
    object.add("z", new JsonPrimitive(this.pos.getZ()));
